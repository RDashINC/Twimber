...
class Twitter
{
	...
	{
		return $this->request('favorites/create', 'POST', array('id' => $id));
	}
	...
	{
		return $this->request('statuses/retweet/', 'POST', array('id' => $id));
	}
 ...
 */
 if(!class_exists('TwitterException')) {
